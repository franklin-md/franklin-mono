...
export interface SystemPromptAssembler {
	 ...
	 * Within each bucket, fragments preserve handler order. Registry-level
	 * API transforms such as `priority.high(api)` reorder handlers before
	 * they reach this assembler.
	 *
