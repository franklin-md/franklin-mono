...
const instructions =
	'When the prompt includes resources the user is currently viewing, treat that list as lightweight UI context. If a viewed resource could be relevant to the user request, consider using an available reading tool to inspect it before answering. Do not assume listed resources have already been read.';
