...
- **Compiler**: API-family-aware registration sink plus runtime builder. It exposes `register(...)`, which binds the API HKT to the compile context runtime for each extension.
